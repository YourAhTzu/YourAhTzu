/*
 ...
 变量：wcCookie='xxxx@12345678910#abcdefg'
 cron 10 8,10,19 * * *
 */
 const $ = new Env('望潮')
 ...
 let cookiesArr = [],
   ...
   channelId = ["639abec5e305b418fc469e3b"]
 cookie = ($.isNode() ? process.env.wcCookie : $.getdata("wcCookie")) || ``
 helpAu = ($.isNode() ? process.env.wchelpAu : $.getdata("wchelpAu")) || true
 !(async () => {
     await requireConfig();
